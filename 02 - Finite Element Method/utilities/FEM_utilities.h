    ...
    private:
        ...
        */
        ...
        /*
            ...
            del elemento.
        */
        static void calculate_local_C(DS<float>* A, Point* P1, Point* P2, Point* P3){
    ...
    public:
        ...
        */
        static DS<float>* calculate_local_M(Element* e){
            ...
            //Se definen los elementos de la matriz de acuerdo a la fórmula posición por posición
            SDDS<float>::insert(M,0,0,2); SDDS<float>::insert(M,0,1,1); SDDS<float>::insert(M,0,2,4);
            SDDS<float>::insert(M,1,0,1); SDDS<float>::insert(M,1,1,2); SDDS<float>::insert(M,1,2,4);
            SDDS<float>::insert(M,2,0,4); SDDS<float>::insert(M,2,1,4); SDDS<float>::insert(M,2,2,20);
        ...
        */
        static DS<float>* calculate_local_K(Element* e){
            ...
            SDDS<float>::create(&C_T,2,2,MATRIX);
            ...
            DS<float>* temp = Math::product( B_T, C_T );
            DS<float>* temp2 = Math::product( temp, C );
        ...
        /*
            ...
            método privado calculate_local_J() en esta clase.
        */
        static DS<float>* calculate_local_b1(Element* e){
        ...
        static DS<float>* calculate_local_b2(Element* e){
            //Se define la matriz b con dimensiones 3 x 1
            //Esto corresponde a las dimensiones resultantes para la aplicación del MEF
            //a un problema 2D
            DS<float>* b;
